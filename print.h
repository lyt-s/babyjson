...
struct _printer {
  static void print(T const &t) { std::cout << t; }
...
template <class T, class U>
struct _enable_if_has_print<
    T, U, std::void_t<decltype(std::declval<T const &>().do_print())>> {
  using type = U;
};
...
struct _printer<T, typename _enable_if_has_print<T>::type> {
  static void print(T const &t) { t.do_print(); }
};
...
struct _printer<T, typename _enable_if_has_print<
  ...
  static void print(T const &t) { std::cout << std::quoted(t); }
};
...
struct _printer<std::nullptr_t, void> {
  static void print(std::nullptr_t const &) { std::cout << "nullptr"; }
};

template <>
struct _printer<std::nullopt_t, void> {
  static void print(std::nullopt_t const &) { std::cout << "nullopt"; }
};

template <>
struct _printer<std::monostate, void> {
  static void print(std::monostate const &) { std::cout << "monostate"; }
};
...
struct _printer<T, typename _enable_if_has_print<
  ...
  static void print(T const &t) {
    std::visit(
        [](auto const &v) { _printer<_rmcvref_t<decltype(v)>>::print(v); }, t);
  }
};
